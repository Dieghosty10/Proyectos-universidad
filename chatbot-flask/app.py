...
reglas_chatbot = {
    ...
    'creador': {
        ...
        'respuesta': 'Fui desarrollado Diego. ¡Es un placer ayudarte!'
    },
    'hora': {
        'palabras': ['que hora es', 'dime la hora', 'hora actual', 'qué horas son'],
    ...
    'ayuda': {
        'palabras': ['que puedes hacer', 'para qué sirves', 'ayuda', 'funciones', 'qué ofreces'],
    ...
    'recomendaciones': {
        'palabras': ['recomiendame', 'sugerencia', 'qué me recomiendas', 'ideas', 'consejo'],
